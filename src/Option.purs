...
-- | someOption = Option.insert (Proxy :: _ "bar") 31 Option.empty
-- |
...
class EncodeJsonOption (list :: Prim.RowList.RowList Type) (option :: Row Type) | list -> option where
  ...
  -- |
  -- | It will commonly be `Proxy`, but doesn't have to be.
  encodeJsonOption
    :: Proxy list
    -> Option option
    -> Foreign.Object.Object Data.Argonaut.Core.Json
...
class GetAll (option :: Row Type) (record :: Row Type) | option -> record where
  ...
  -- | ```PureScript
  -- | someOption :: Option.Option ( foo :: Boolean, bar :: Int )
  -- | someOption = Option.insert (Data.Symbol.Proxy :: _ "bar") 31 Option.empty
  -- |
  ...
  -- | bar :: Data.Maybe.Maybe (Record ( foo :: Boolean, bar :: Int))
  -- | bar = Option.getAll' (Option.insert (Data.Symbol.Proxy :: _ "foo") true someOption)
  -- | ```
  getAll'
    :: Option option
...
-- | anotherRecord = Option.rename' { bar: Proxy :: _ "bar2" } someRecord
-- | ```
...
-- | Instead of having to say:
-- | ```PureScript
-- | Option.get (Proxy :: _ "foo") someOption
-- | ```
-- |
...
alter' f _ (Option object) = { option, value }
  ...
  key :: String
  key = Data.Symbol.reflectSymbol (Proxy :: Proxy label)
...
-- |
-- | anotherOption :: Option.Option ( bar :: Int )
-- | anotherOption = Option.delete (Proxy :: _ "foo") someOption
-- | ```
-- |
...
-- | bar = Option.get (Proxy :: _ "bar") someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
-- | -- This will be `Just { foo: true, bar: 31 }` because all keys exist in the option.
-- | bar :: Data.Maybe.Maybe (Record ( foo :: Boolean, bar :: Int))
-- | bar = Option.getAll (Option.insert (Proxy :: _ "foo") true someOption)
-- | ```
getAll
...
-- |
-- | bar :: Int
-- | bar = Option.getWithDefault 13 (Proxy :: _ "bar") someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
-- | It will commonly be `Data.Symbol.Proxy`, but doesn't have to be.
getWithDefault
  :: forall label option option' proxy value
   . Data.Symbol.IsSymbol label
  => Prim.Row.Cons label value option' option
...
-- |
-- | anotherOption :: Option.Option ( foo :: Boolean, bar :: Int )
-- | anotherOption = Option.insert (Data.Symbol.Proxy :: _ "bar") 31 someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
-- |
-- | anotherOption :: Option.Option ( foo :: Boolean, bar :: Int )
-- | anotherOption = Option.insertField (Data.Symbol.Proxy :: _ "bar") someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
-- |
-- | anotherOption :: Option.Option ( foo :: Boolean, bar :: Int )
-- | anotherOption = Option.modify (Data.Symbol.Proxy :: _ "bar") (_ + 1) someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
-- | anotherRecord = Option.recordRename { bar: Data.Symbol.Proxy :: _ "bar2" } someRecord
-- | ```
recordRename
...
-- | anotherOption = Option.rename { bar: Data.Symbol.Proxy :: _ "bar2" } someOption
-- | ```
rename
...
-- |
-- | anotherOption :: Option.Option ( foo :: Boolean, bar :: Int )
-- | anotherOption = Option.set (Data.Symbol.Proxy :: _ "bar") 31 someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
type User = Option (username :: String, age :: Int)
...
user27 = rename { age: Proxy :: Proxy "age1" } user

user28 :: Option (age :: Int, username2 :: String)
user28 = rename { username: Proxy :: Proxy "username2" } user
...
greeting8 = recordRename { name: Proxy :: Proxy "Name", title: Proxy :: Proxy "Title" } greeting1
